<tr class="webshipper_drop_point">
   ...
   <td class="webshipper_drop_point_container">
      ...
      <button type="button" style="float: none;" id="webshipper-modal-open"><?php echo esc_html(___('select pickup point')) ?></button>
      ...
      <style>
         ...
         .webshipper_drop_point_selector_title {
            white-space: nowrap;
         }
