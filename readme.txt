...
* Integrate with DAO
* Integrate with CoolRunner/Homerunner
...
* 1.5.8 Made drop point selection required when shipping service requires it. Also, updated minified javascript file.
* 1.5.9 Now tested up to WordPress version 6.5 & WooCommerce version 8.7.0